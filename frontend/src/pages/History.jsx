              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="text-center p-4 bg-secondary/10 rounded-xl">
                  ...
                  <h3 className="text-2xl font-bold text-secondary">
                    {
                      new Set(announcements.flatMap((a) => a.languages || []))
                        .size
                    }
                  </h3>
                  <p className="text-text-light dark:text-text-dark">
                ...
                <div className="text-center p-4 bg-accent/10 rounded-xl">
                  ...
                  <h3 className="text-2xl font-bold text-accent">
                    {announcements.reduce(
                      (total, a) =>
                        total + Object.keys(a.audio_files || {}).length,
                      0
                    )}
                  </h3>
                  <p className="text-text-light dark:text-text-dark">
            ...
            <div className="space-y-6">
              ...
              {announcements.length === 0 ? (
                ...
                announcements.map((announcement, index) => (
                  <div
                    key={announcement.id}
                    className="bg-card-light dark:bg-card-dark rounded-2xl shadow-lg overflow-hidden"
                  >
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-4">
                        <div className="flex flex-wrap gap-2">
                          {announcement.languages?.map((lang) => (
                            <span
                              key={lang}
                              className="bg-subtle-light dark:bg-subtle-dark px-3 py-1 rounded-full text-sm"
                            >
                        ...
                        <div className="flex gap-2">
                          {announcement.audio_files &&
                            Object.entries(announcement.audio_files).map(
                              ([lang, url]) => (
                                <button
                                  key={lang}
                                  onClick={() =>
                                    playAudio(url, languageNames[lang] || lang)
                                  }
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {selectedAnnouncement.translations &&
                      Object.entries(selectedAnnouncement.translations).map(
                        ([lang, text]) => (
                          <div
                            key={lang}
                            className="bg-subtle-light/50 dark:bg-subtle-dark/50 rounded-xl p-4"
                          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    {selectedAnnouncement.languages
                      ?.map((lang) => languageNames[lang] || lang)
                      .join(", ")}
                  </div>
                  <div>
                    <span className="font-semibold">Tone:</span>{" "}
                    {selectedAnnouncement.tone}
                  </div>
                  <div>
